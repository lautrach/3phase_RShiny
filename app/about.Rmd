...
# **Optimal Trap Placement Application Overview**
...
<div style="padding: 10px;  border-radius: 8px;">
This phase calculates a **performance score** for each trap, which is visualized through an intuitive **heatmap**. The heatmap provides a clear representation of the score distribution across all trap locations, making it easy to identify high and low-performing traps.
</div>
